...
import DropdownCountsInput from "../../UIComponents/dropdownCountsInput/dropdownCountsInput.component";
import {
  GroupIcon,
...
const TourBookingInputs = () => {
  ...
  const [label, setLabel] = useState("Add people");

  const handleDropDownEdit = (newState) => {
